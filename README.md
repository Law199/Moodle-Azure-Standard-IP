...
| Minimal (internal Load Balancer) | Same as Minimal, but uses an internal Standard Load Balancer and a NAT Gateway for web-tier outbound connectivity. The internal Load Balancer can be used as a private backend for an Application Gateway.|[![Deploy to Azure Minimally with Internal Load Balancer](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy-minimal-internal-lb.json)|
...
| Small to Mid-Size (internal Load Balancer) | Same as Small to Mid-Size, but uses an internal Standard Load Balancer and a NAT Gateway for web-tier outbound connectivity. The internal Load Balancer can be used as a private backend for an Application Gateway.|[![Deploy to Azure Small to Mid-Size with Internal Load Balancer](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy-small2mid-noha-internal-lb.json)|
