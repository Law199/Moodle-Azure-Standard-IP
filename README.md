...
| Deployment Type | Load Balancer | Description | Launch |
| --- | --- | --- | --- |
| Minimal | Public Standard LB | NFS, Azure Database for MySQL Flexible Server (Burstable SKU 2 vCores), and a small autoscale web frontend. | [Deploy to Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy-minimal.json) |
| Minimal | Internal Standard LB + NAT Gateway | Same as Minimal, with a private Load Balancer frontend and NAT Gateway outbound connectivity for a later Application Gateway integration. | [Deploy to Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy-minimal-internal-lb.json) |
| Small to Mid-Size | Public Standard LB | Supports up to 1000 concurrent users with NFS and Azure Database for MySQL Flexible Server (General Purpose, 8 vCores). | [Deploy to Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy-small2mid-noha.json) |
| Small to Mid-Size | Internal Standard LB + NAT Gateway | Same as Small to Mid-Size, with a private Load Balancer frontend and NAT Gateway outbound connectivity for a later Application Gateway integration. | [Deploy to Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy-small2mid-noha-internal-lb.json) |
| Large size deployment (with high availability) | Public Standard LB | Premium Files, Azure Database for MySQL Flexible Server (General Purpose, 16 vCores), and Redis Cache. | [Deploy to Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy-large-ha.json) |
| Maximum | Public Standard LB | Premium Files, Azure Database for MySQL Flexible Server (Business Critical, 64 vCores), Redis Cache, and Elasticsearch. | [Deploy to Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy-maximal.json) |
...
[![Deploy to Azure Fully Configurable](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy.json)  [![Visualize](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/visualizebutton.png)](http://armviz.io/#/?load=https%3A%2F%2Fraw.githubusercontent.com%2FLaw199%2FMoodle-Azure-Standard-IP%2Fmaster%2Fazuredeploy.json)
...
- Internal deployment variants use an internal Standard Load Balancer and [Azure NAT Gateway](https://learn.microsoft.com/en-us/azure/nat-gateway/nat-gateway-resource) for private backend connectivity and web-tier outbound access
